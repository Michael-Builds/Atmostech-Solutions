            ...
            <div className="mx-auto w-full max-w-7xl px-8 ">
                ...
                <div className="flex w-full  flex-col items-center justify-center border-t border-blue-gray-200 py-4 border-t-1 md:flex-row md:justify-between">
                    ...
                    <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
                        <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100 hover:text-blue-900">
                        ...
                        <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100 hover:text-pink-700">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                                    fill-rule="evenodd"
                        ...
                        <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100 hover:text-blue-700">
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
