...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            ></div>
            <h1 id='software-head' className={`mb-5 contact-header z-10 ${inView1 ? 'fade-in-bottom fade-in-bottom-active' : ''
                }`}
                ref={ref1}>Software Development</h1>
            <h3 id='software-sub' className={`mb-4  contact-sub z-10 ${inView1 ? 'fade-in-bottom fade-in-bottom-active' : ''
                }`}>
