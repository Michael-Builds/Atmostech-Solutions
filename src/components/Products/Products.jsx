...
const ServicesProducts = () => {
  ...
  useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto flex justify-center">
                ...
                <Card className="flex-row w-full max-w-[38rem] head  animate-pulse"
    ...
    >
      ...
      <CardBody>
        <Typography variant="h6" color="blue" className="uppercase mb-4 title-typo">Uni-Mart</Typography>
        <Typography variant="h4" color="blue-gray" className="mb-2 sub">
